...
const create_query = [
  ...
  `USE meetup`,
  `CREATE TABLE Invitee (invitee_no int, invitee_name varchar(200), invited_by varchar(50));`,
  `CREATE TABLE Room (room_no int, room_name varchar(200), floor_number smallint);`,
  `CREATE TABLE Meeting (meeting_no int, meeting_title varchar(200), starting_time datetime, ending_time datetime, room_no int);`,
